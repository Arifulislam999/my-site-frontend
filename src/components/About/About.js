    ...
    return (
        <div className="about">
            ...
            <p className="about-text">
                I'm a Freelancer Front-end Developer with over 1.2 years of
                experience. I'm from Kushtia Islamic University,Bangladesh. I
                code and create web elements for amazing people around the
                world. I like work with new people. New people are new
                experiences
            </p>
